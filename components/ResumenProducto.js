  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div className="md: w-4/6">
        ...
        <p className="text-sm mt-2">Precio: {formatearDinero(producto.precio * producto.cantidad)}</p>
      </div>
      <div>
        <button
        type="button"
        className="bg-sky-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full mb-5"
